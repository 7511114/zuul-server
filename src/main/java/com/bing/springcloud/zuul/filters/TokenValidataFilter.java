package com.bing.springcloud.zuul.filters;
...
import com.bing.springcloud.jwt.uaa.JwtTokenProvider;
import com.bing.springcloud.zuul.ConfigurationBean;
...
public class TokenValidataFilter extends ZuulFilter {
	...
	public TokenValidataFilter(JwtTokenProvider jwtTokenProvider, ConfigurationBean configurationBean) {
	...
	public boolean shouldFilter() {
		...
		return !configurationBean.getNoAuthenticationRoutes().contains(ctx.get("proxy"));
	}
